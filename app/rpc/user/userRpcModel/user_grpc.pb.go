...
func (c *loginClient) Register(ctx context.Context, in *ReqRegister, opts ...grpc.CallOption) (*ResRegister, error) {
	out := new(ResRegister)
...
func (c *loginClient) Login(ctx context.Context, in *ReqLogin, opts ...grpc.CallOption) (*ResLogin, error) {
	out := new(ResLogin)
...
func (UnimplementedLoginServer) Register(context.Context, *ReqRegister) (*ResRegister, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedLoginServer) Login(context.Context, *ReqLogin) (*ResLogin, error) {
...
func _Login_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServer).Register(ctx, req.(*ReqRegister))
	}
